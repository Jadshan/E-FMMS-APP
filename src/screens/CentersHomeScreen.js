...
import MenuScreen from './CenterTabs/MenuScreen';
...
const CentersHomeScreen = ({navigation,route}) => {
    ...
    return (
        <View style ={styles.container}>
            <ScrollView>
                <View>
                     <CenterHeader id ={id} navigation ={navigation} />
...
export default CentersHomeScreen
